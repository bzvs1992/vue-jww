<template>
  <div class="game">
    ...
    <transition name="fadein">
     ...
     <iframe src="https://game.niu.xunlei.com/pay/dfwpay.html" frameborder="0" v-if="popPay" style="position:absolute;top:0;left:0;width:100%;height:100%;z-index:200;"></iframe>
     <div style="position:absolute;top:12%;right:10%;width:40px;height:40px;z-index:210;" @click="cloPay"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openPay() {
        // this.$http.jsonp(this.h5url + 'recharge/getlist', {
        //   jsonp: 'cb'
        // }).then(function (res) {
        //   if (res.body.rtn == 0) {
        //     this.payBeanConfig = [];
